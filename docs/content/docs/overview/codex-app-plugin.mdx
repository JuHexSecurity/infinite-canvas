...
```text
Install the Infinite Canvas Codex plugin from https://github.com/JuHexSecurity/infinite-canvas.git.
...
```bash
mkdir -p ~/plugins
git clone https://github.com/JuHexSecurity/infinite-canvas.git ~/plugins/infinite-canvas
